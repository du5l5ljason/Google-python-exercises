...
The runTest() below is already defined and complete. It calls print_words()
...
def print_words(fn):
    ...
    # sort dict in order by word
    result = utils.sort_dict_by_keyname(dict)
    print result
...
def runTest():
  if len(sys.argv) != 3:
    print 'usage: ./wordcountTest.py {--count | --topcount} file'
    sys.exit(1)
